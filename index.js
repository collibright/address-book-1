   ...
   AddressBook.prototype = {
     ...
     search:function(searchTerm){
       if(this.data.length){
         ...
         console.log("There are no results yet");
       }
       return this;
     },
...
searchForm.addEventListener('submit', function(){
  ...
  if(results.length>0){
   ...
   document.getElementById('results').innerHTML += '<div class="contact-item">No results for this name</div><hr>';
  }
  ...
  if(window.contactList){ 
   ...
   var contacts = contactList.returnAll();
    ...
    if(contacts.length>0){
      ...
      document.getElementById('show-panel').innerHTML += '<div class="contact-item"> No contacts yet. kindly add few</div><hr>';
    }
  }
